...
**Everything lives in one file.** The whole system is a single Markdown file, `phanes.md`. Every script, hook, agent, and document it depends on is generated by the run itself, right inside your repository.
