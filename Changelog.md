...
All notable changes to **Phanes** (PhanesLight edition). The authoritative version marker is the stamp on the first line of `phanes.md` — diff it against this repository before assuming your installed copy is current.
